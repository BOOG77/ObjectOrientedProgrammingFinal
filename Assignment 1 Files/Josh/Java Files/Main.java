...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!exit) { // Infinite loop to display the menu until the user exits the program
            ...
            switch (choice) { // Switch case based on the user's choice
                case 1 -> { // If the user chooses option 1
                    ...
                    System.out.println(" ");
                    System.out.println("====================================");
                    System.out.println("Uploading student details to program...."); // Print message about uploading
                                                                                    // student details
                ...
                case 3 -> { // If the user chooses option 3
                    ...
                    if (!studentFound) { // If the student is not found
                        System.out.println("Student with ID " + searchId + " not found."); // Display a message stating
                ...
                case 4 -> { // If the user chooses option 4
                    System.out.println(" ");
                    System.out.println("Exiting the program..."); // Display a message stating the action of exiting the
                                                                  // program
                ...
                default -> {
                    ...
                    System.out.println("=========================================================");
                    System.out.println(
                            "Invalid input detected.\nPlease try again, entering one of the options available."); // If
                                                                                                                  // the
                                                                                                                  // user
                                                                                                                  // enters
                                                                                                                  // an
        ...
        System.out.println("Thank you for using the Student Management System!"); // Display a "thank you" message for
                                                                                  // using the program
